...
@section('title', 'Crear Nueva Sala')
    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="row row-deck row-cards">
                <div class="col-12">
                    <form action="{{ route('salas.store') }}" method="POST" class="card">
                        @csrf
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <select name="tipo" class="form-select @error('tipo') is-invalid @enderror" required>
                                            ...
                                            <option value="sala_de_juntas" {{ old('tipo') == 'sala_de_juntas' ? 'selected' : '' }}>Sala de Juntas</option>
                                        </select>
                                        @error('tipo')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="descripcion" class="form-control @error('descripcion') is-invalid @enderror" 
                                                  rows="4" placeholder="Describe el equipamiento, características especiales, etc.">{{ old('descripcion') }}</textarea>
                                        @error('descripcion')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                        ...
                        <div class="card-footer text-end">
                            <div class="d-flex">
                                <a href="{{ route('salas.index') }}" class="btn btn-link">Cancelar</a>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    nombreInput.addEventListener('input', function() {
        if (!codigoInput.value || codigoInput.value === codigoInput.getAttribute('data-generated')) {
            ...
            codigoInput.setAttribute('data-generated', codigo);
        }
    });
});
</script>
