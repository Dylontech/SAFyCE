...
@section('title', 'Editar Recurso - Biblioteca Virtual')
            ...
            <div class="row g-2 align-items-center">
                <div class="col">
                    ...
                    <h2 class="page-title">
                        ...
                        Editar Recurso: {{ $bibliotecaVirtual->nombre }}
                    </h2>
                </div>
            </div>
        </div>
    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <form action="{{ route('biblioteca-virtual.update', $bibliotecaVirtual) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="card">
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" name="nombre" class="form-control @error('nombre') is-invalid @enderror" 
                                               value="{{ old('nombre', $bibliotecaVirtual->nombre) }}" placeholder="Ej: eLibro, EBSCOhost, SciELO">
                                        @error('nombre')
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="url" name="url" class="form-control @error('url') is-invalid @enderror" 
                                               value="{{ old('url', $bibliotecaVirtual->url) }}" placeholder="https://ejemplo.com">
                                        @error('url')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="categoria" class="form-select @error('categoria') is-invalid @enderror">
                                            ...
                                            @foreach($categorias as $key => $label)
                                                <option value="{{ $key }}" {{ old('categoria', $bibliotecaVirtual->categoria) == $key ? 'selected' : '' }}>
                                                    {{ $label }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" name="orden" class="form-control @error('orden') is-invalid @enderror" 
                                               value="{{ old('orden', $bibliotecaVirtual->orden) }}" min="0">
                                        @error('orden')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea name="descripcion" class="form-control @error('descripcion') is-invalid @enderror" 
                                                  rows="3" placeholder="Descripción breve del recurso...">{{ old('descripcion', $bibliotecaVirtual->descripcion) }}</textarea>
                                        @error('descripcion')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" name="icono" class="form-control @error('icono') is-invalid @enderror" 
                                               value="{{ old('icono', $bibliotecaVirtual->icono) }}" placeholder="Ej: fas fa-book, fas fa-database">
                                        @error('icono')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-check">
                                            <input type="checkbox" name="activo" class="form-check-input" id="activo" 
                                                   value="1" {{ old('activo', $bibliotecaVirtual->activo) ? 'checked' : '' }}>
